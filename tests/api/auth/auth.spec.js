...
import { defaultOrgData, validateAuthCookies } from "../../utils/helpers.js";
test.describe("Auth Module", () => {
    let createdUserEmail;
    let createdUserPassword;
    test("POST /auth/register Then POST /auth/login should register and login the newly created user ", async ({ request, }) => {
    ...
    test("GET /auth/me - should return current user details", async ({ request, }) => {
