...
import { generateRandomEmail, generateRandomPhone, } from "../../utils/helpers.js";
test.describe("Customers Module", () => {
    test("POST /customers - should create and then list customer", async ({ request, }) => {
        ...
        const found = body.data.customers.find((c) => c.idNumber === idNumber);
